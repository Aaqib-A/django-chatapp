...
from rt_chat.forms import ChatMessageCreateForm, NewGroupForm, ChatRoomEditForm
    ...
    if chat_group.groupchat_name:
        if request.user not in chat_group.members.all():
            ...
            if request.user.emailaddress_set.filter(verified=True).exists():
                ...
                messages.warning(request, 'You need to verify email to join our chat!')
...
def chatroom_delete_view(request, chatroom_name):
    ...
    return render(request, 'rt_chat/chatroom_delete.html', {'chat_group': chat_group})
